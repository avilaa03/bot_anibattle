    ...
    while (vivos.length > 1) {
        ...
        for (let i = 0; i < vivos.length; i += 2) {
            ...
            if (!b) {
                ...
                // 'BYE' é um código, não texto de tela. O placar fica
                // gravado no banco e pode ser exibido meses depois, em
                // outro idioma — guardar "passou direto" aqui congelaria
                // o português no histórico do torneio.
                confrontos.push({
