...
module.exports = (interaction, message, indexRef, matchingCards, user, favCardEnd, updateEmbed, createRow, t = criarT(DEFAULT_LOCALE)) => {
    ...
    collector.on('collect', async i => {
        if (i.customId === 'prev') {
            ...
            await i.update({
                embeds: [ui.neutral(t('undosell.cancelado'), t('favcard.cancelado_texto'))],
                components: []
            });
            collector.stop('collected');
        }
